...
public class C3L3 : MonoBehaviour
{
	...
	void Start()
    {
		...
		//anObjectWithSpriteRenderer.transform.position = new UnityEngine.Vector2(1.8f, 0.0f);
	...
	public void Update(){
        ...
        {
			//myObj.SetActive(false); // true
			myObj.transform.position =new UnityEngine.Vector2(0.1f, 0.0f);
        }
